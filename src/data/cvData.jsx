...
// Composant réutilisable pour les compétences
export const SkillCard = ({ logoUrl, name }) => (
  <div style={{
    ...
    <span style={{ fontSize: '1rem', color: '#1e293b' }}>{name}</span>
  </div>
);

// Les zones cliquables de la chambre
...
// La fonction qui génère tout le contenu texte de ton CV
export const getCvData = (setShowGame, setShowInvaders, setActiveSection) => ({
    ...
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px' }}>
        <div style={{ backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ backgroundColor: '#fff', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '15px', fontSize: '1rem', color: '#475569', maxHeight: '150px', overflowY: 'auto' }}>
          ...
          <a href="https://github.com/abdemeh/projet-kosmio-front" target="_blank" rel="noreferrer" style={{ alignSelf: 'flex-start', backgroundColor: '#24292f', color: '#fff', padding: '8px 16px', borderRadius: '20px', textDecoration: 'none', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={{ backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <a href="https://github.com/SEMGOODD/PokemonDrafter" target="_blank" rel="noreferrer" style={{ alignSelf: 'flex-start', backgroundColor: '#24292f', color: '#fff', padding: '8px 16px', borderRadius: '20px', textDecoration: 'none', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" style={{ width: '16px', filter: 'invert(1)' }} />
            Voir sur GitHub
          </a>
        </div>
        
        {/* LE BOUTON SPACE INVADERS */}
        <div onClick={() => { setShowInvaders(true); setActiveSection(null); }} style={{ marginTop: '15px', padding: '15px', backgroundColor: '#fee2e2', borderRadius: '16px', border: '2px dashed #ef4444', textAlign: 'center', cursor: 'pointer', transition: '0.2s', fontSize: '1.2rem', color: '#ef4444' }} onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.02)'} onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}>
  ...
  skills: {
    ...
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px' }}>
        <h3 style={{ fontSize: '1.2rem', color: '#3b82f6', marginBottom: '5px', borderBottom: '1px solid #eee' }}>Cloud Providers</h3>
        ...
        <h3 style={{ fontSize: '1.2rem', color: '#3b82f6', marginBottom: '5px', borderBottom: '1px solid #eee' }}>Langages</h3>
        ...
        <h3 style={{ fontSize: '1.2rem', color: '#3b82f6', marginBottom: '5px', borderBottom: '1px solid #eee' }}>Outils & OS</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '12px' }}>
        ...
        <h3 style={{ fontSize: '1.2rem', color: '#3b82f6', marginBottom: '5px', borderBottom: '1px solid #eee' }}>Langues</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '12px' }}>
    ...
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', backgroundColor: '#f8fafc', padding: '15px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          ...
          <div>
            <h4 style={{ margin: 0, color: '#0f172a', fontSize: '1.3rem' }}>Diplôme Ingénieur Informatique</h4>
            <p style={{ margin: '4px 0 0 0', color: '#64748b', fontSize: '1rem' }}><b>CY TECH Cergy</b> • En cours (Cycle Ingénieur)</p>
          </div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', backgroundColor: '#f8fafc', padding: '15px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          <div style={{ width: '60px', height: '60px', backgroundColor: '#fff', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, overflow: 'hidden', border: '1px solid #eee' }}>
          ...
          <div>
            <h4 style={{ margin: 0, color: '#0f172a', fontSize: '1.3rem' }}>DUT Informatique</h4>
            <p style={{ margin: '4px 0 0 0', color: '#64748b', fontSize: '1rem' }}><b>Université Paris-Saclay</b> • Promotion 2021</p>
          </div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
          <div style={{ backgroundColor: '#fff7ed', padding: '15px', borderRadius: '12px', border: '1px solid #ffedd5', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
             ...
             <span style={{ fontSize: '1rem', color: '#9a3412' }}>Cloud Associate Engineer</span>
             <span style={{ fontSize: '0.9rem', color: '#c2410c' }}>Google Cloud Certified</span>
          </div>
          <div style={{ backgroundColor: '#f0fdf4', padding: '15px', borderRadius: '12px', border: '1px solid #dcfce7', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
             <div style={{ width: '40px', height: '40px', backgroundColor: '#16a34a', borderRadius: '50%', marginBottom: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '1.2rem' }}>890</div>
             <span style={{ fontSize: '1rem', color: '#166534' }}>TOEIC Score</span>
             <span style={{ fontSize: '0.9rem', color: '#15803d' }}>Niveau Professionnel</span>
          </div>
        </div>
      </div>
    ),
    ...
    content: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <a href="mailto:orsolleeth@cy-tech.fr" style={{ color: '#3b82f6', textDecoration: 'none', fontSize: '1.2rem' }}>orsolleeth@cy-tech.fr</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <a href="tel:+33651517384" style={{ color: '#3b82f6', textDecoration: 'none', fontSize: '1.2rem' }}>+33 6 51 51 73 84</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <a href="https://www.linkedin.com/in/ethan-orsolle-tyberg" target="_blank" rel="noreferrer" style={{ color: '#3b82f6', textDecoration: 'none', fontSize: '1.2rem' }}>@ethan-orsolle-tyberg</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          ...
          <a href="https://github.com/eorstyb" target="_blank" rel="noreferrer" style={{ color: '#3b82f6', textDecoration: 'none', fontSize: '1.2rem' }}>eorstyb</a>
        </div>
        <a href="/CV_ETHAN_ORSOLLE.pdf" target="_blank" rel="noreferrer" style={{
          justifyContent: 'center', alignSelf: 'center',
          backgroundColor: '#3b82f6', color: '#fff', border: 'none', padding: '12px 24px', fontSize: '1.2rem',
          borderRadius: '25px', cursor: 'pointer', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '10px', marginTop: '10px',
    ...
    content: (
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '15px', marginTop: '10px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#fdf4ff', padding: '15px', borderRadius: '12px', border: '1px solid #fae8ff' }}>
          <span style={{ fontSize: '2.5rem', marginBottom: '5px' }}>🎵</span>
          <b style={{ fontSize: '1rem' }}>Musique</b>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#f8fafc', padding: '15px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          <span style={{ fontSize: '2.5rem', marginBottom: '5px' }}>🎬</span>
          <b style={{ fontSize: '1rem' }}>Cinéma</b>
        </div>
      </div>
    ),
  },
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '25px', marginTop: '10px' }}>
        <div>
          ...
          <div onClick={() => { setShowGame(true); setActiveSection(null); }} title="Cliquez pour lancer mon Memory Game !"
            ...
            <div style={{ gridColumn: 'span 4', marginTop: '15px', padding: '10px', backgroundColor: 'rgba(239, 68, 68, 0.1)', borderRadius: '8px', fontSize: '1rem', color: '#b91c1c', border: '1px solid #fecdd3', textAlign: 'center' }}>
              💡 Cliquez sur la boîte pour tester mon Memory Game !
            </div>
          </div>
        </div>
        <div>
          <h3 style={{ fontSize: '1.2rem', color: '#6366f1', marginBottom: '15px', borderBottom: '2px solid #e0e7ff', paddingBottom: '8px', letterSpacing: '1px' }}>CULTURE</h3>
          <div style={{
